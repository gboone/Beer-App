...
<div class="container" id="form">
	...
	<div class="row">
		...
		<div class="span4 btn-group" data-toggle="buttons-radio">
			<h3>Size:</h3>
				...
				<button type="button" class="btn btn-block" name="size" onClick="$('#size').val('25.36');">750ml (wine bottle, oil can)</button>
	...
	<div class="row">
		<div class="span9"><input type="submit" id="submit" class="btn btn-block" name="submit" onclick="$('#BeerNum').modal('show')"></div>
...
<!--  <div class="modal-header">
    ...
    <h3 id="myModalLabel">Your Beer Number:</h3>
  </div>
  <div class="modal-body">
-->
    <?	
    //include('beer-ajax.php')
    //if (empty($beer)) {
